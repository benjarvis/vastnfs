...
{
	compat_iov_iter_kvec(&msg->msg_iter, WRITE, vec, 1, vec->iov_len);
			      ...
			      struct xdr_buf *xdr, size_t base)
{
	...
	compat_iov_iter_bvec(&msg->msg_iter, WRITE, xdr->bvec, xdr_buf_pagecount(xdr),
				 ...
				 size_t base)
{
	...
	compat_iov_iter_kvec(&msg->msg_iter, WRITE, iov, 2, len);
