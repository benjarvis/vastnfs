...
static void rpcb_xdr_enc_mapping(struct rpc_rqst *req, struct xdr_stream *xdr,
			     const void *data)
{
...
static int rpcb_xdr_dec_getport(struct rpc_rqst *req, struct xdr_stream *xdr,
			    void *data)
{
...
static int rpcb_xdr_dec_set(struct rpc_rqst *req, struct xdr_stream *xdr,
			void *data)
{
...
static void rpcb_xdr_enc_getaddr(struct rpc_rqst *req, struct xdr_stream *xdr,
			     const void *data)
{
	const struct rpcbind_args *rpcb = data;
	__be32 *p;
...
static int rpcb_xdr_dec_getaddr(struct rpc_rqst *req, struct xdr_stream *xdr,
			    void *data)
{
	struct rpcbind_args *rpcb = data;
...
xdr_trace_encode_wrap(rpcb, mapping, mapping);
xdr_trace_encode_wrap(rpcb, getaddr, getaddr);
xdr_trace_decode_wrap(rpcb, set, set);
xdr_trace_decode_wrap(rpcb, getport, getport);
xdr_trace_decode_wrap(rpcb, getaddr, getaddr);
...
static const struct rpc_procinfo rpcb_procedures2[] = {
	[RPCBPROC_SET] = {
		.p_proc		= RPCBPROC_SET,
		.p_encode	= rpcb_xdr_trace_enc_mapping,
		.p_decode	= rpcb_xdr_trace_dec_set,
	...
	[RPCBPROC_GETPORT] = {
		...
		.p_encode	= rpcb_xdr_trace_enc_mapping,
		.p_decode	= rpcb_xdr_trace_dec_getport,
		.p_arglen	= RPCB_mappingargs_sz,
...
static const struct rpc_procinfo rpcb_procedures3[] = {
	[RPCBPROC_SET] = {
		.p_proc		= RPCBPROC_SET,
		.p_encode	= rpcb_xdr_trace_enc_getaddr,
		.p_decode	= rpcb_xdr_trace_dec_set,
	...
	[RPCBPROC_GETADDR] = {
		...
		.p_encode	= rpcb_xdr_trace_enc_getaddr,
		.p_decode	= rpcb_xdr_trace_dec_getaddr,
		.p_arglen	= RPCB_getaddrargs_sz,
