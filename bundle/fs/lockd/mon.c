...
xdr_trace_encode_wrap(nsm, mon, mon);
xdr_trace_encode_wrap(nsm, unmon, unmon);

xdr_trace_decode_wrap(nsm, stat, stat);
xdr_trace_decode_wrap(nsm, stat_res, stat_res);

static const struct rpc_procinfo nsm_procedures[] = {
[NSMPROC_MON] = {
		.p_proc		= NSMPROC_MON,
		.p_encode	= nsm_xdr_trace_enc_mon,
		.p_decode	= nsm_xdr_trace_dec_stat_res,
		.p_arglen	= SM_mon_sz,
...
[NSMPROC_UNMON] = {
		...
		.p_encode	= nsm_xdr_trace_enc_unmon,
		.p_decode	= nsm_xdr_trace_dec_stat,
