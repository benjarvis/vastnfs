 ...
 */
#define nlm4_xdr_trace_dec_norep	NULL

xdr_trace_encode_wrap(nlm4, test, testargs);
xdr_trace_encode_wrap(nlm4, test, testres);
xdr_trace_encode_wrap(nlm4, res, res);
xdr_trace_encode_wrap(nlm4, lock, lockargs);
xdr_trace_encode_wrap(nlm4, unlock, unlockargs);
xdr_trace_encode_wrap(nlm4, canc, cancargs);

xdr_trace_decode_wrap(nlm4, test, testres);
xdr_trace_decode_wrap(nlm4, res, res);

#define PROC(proc, argtype, restype)					\
[NLMPROC_##proc] = {							\
	.p_proc      = NLMPROC_##proc,					\
	.p_encode    = nlm4_xdr_trace_enc_##argtype,			\
	.p_decode    = nlm4_xdr_trace_dec_##restype,			\
