...
#define nfs3_xdr_trace_encode_wrap(_prog_, _name_) \
	xdr_trace_encode_wrap(_prog_, _name_, _name_##3args) \

#define nfs3_xdr_trace_decode_wrap(_prog_, _name_) \
	xdr_trace_decode_wrap(_prog_, _name_, _name_##3res) \

#define nfs3_xdr_trace_wrap(_prog_, _name_) \
	nfs3_xdr_trace_encode_wrap(_prog_, _name_) \
	nfs3_xdr_trace_decode_wrap(_prog_, _name_) \

nfs3_xdr_trace_wrap(nfs3, getattr);
nfs3_xdr_trace_wrap(nfs3, setattr);
nfs3_xdr_trace_wrap(nfs3, lookup);
nfs3_xdr_trace_wrap(nfs3, access);
nfs3_xdr_trace_wrap(nfs3, readlink);
nfs3_xdr_trace_wrap(nfs3, read);
nfs3_xdr_trace_wrap(nfs3, write);
nfs3_xdr_trace_wrap(nfs3, create);
nfs3_xdr_trace_encode_wrap(nfs3, mkdir);
nfs3_xdr_trace_encode_wrap(nfs3, symlink);
nfs3_xdr_trace_encode_wrap(nfs3, mknod);
nfs3_xdr_trace_wrap(nfs3, rename);
nfs3_xdr_trace_wrap(nfs3, remove);
nfs3_xdr_trace_wrap(nfs3, link);
nfs3_xdr_trace_wrap(nfs3, readdir);
nfs3_xdr_trace_encode_wrap(nfs3, readdirplus);
nfs3_xdr_trace_decode_wrap(nfs3, fsstat);
nfs3_xdr_trace_decode_wrap(nfs3, fsinfo);
nfs3_xdr_trace_decode_wrap(nfs3, pathconf);
nfs3_xdr_trace_wrap(nfs3, commit);
nfs3_xdr_trace_wrap(nfs3, setacl);
nfs3_xdr_trace_wrap(nfs3, getacl);

#define PROC(proc, argtype, restype, timer)				\
[NFS3PROC_##proc] = {							\
	.p_proc      = NFS3PROC_##proc,					\
	.p_encode    = nfs3_xdr_trace_enc_##argtype##3args,		\
	.p_decode    = nfs3_xdr_trace_dec_##restype##3res,		\
...
static const struct rpc_procinfo nfs3_acl_procedures[] = {
	[ACLPROC3_GETACL] = {
		...
		.p_encode = nfs3_xdr_trace_enc_getacl3args,
		.p_decode = nfs3_xdr_trace_dec_getacl3res,
	...
	[ACLPROC3_SETACL] = {
		...
		.p_encode = nfs3_xdr_trace_enc_setacl3args,
		.p_decode = nfs3_xdr_trace_dec_setacl3res,
