...
nfs3_xdr_trace_encode_wrap(mnt, dirpath);
nfs3_xdr_trace_decode_wrap(mnt, mountres3);
nfs3_xdr_trace_decode_wrap(mnt, mountres);

static const struct rpc_procinfo mnt_procedures[] = {
	[MOUNTPROC_MNT] = {
		.p_proc		= MOUNTPROC_MNT,
		.p_encode	= mnt_xdr_trace_enc_dirpath,
		.p_decode	= mnt_xdr_trace_dec_mountres,
...
static const struct rpc_procinfo mnt3_procedures[] = {
	[MOUNTPROC3_MNT] = {
		...
		.p_encode	= mnt_xdr_trace_enc_dirpath,
		.p_decode	= mnt_xdr_trace_dec_mountres3,
		.p_arglen	= MNT_enc_dirpath_sz,
