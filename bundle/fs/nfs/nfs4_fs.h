...
int nfs_atomic_open(struct inode *, struct dentry *, struct file *,
		    unsigned, umode_t FS_ATOMIC_OPEN_OPENED_PARAM);

/* fs_context.c */
#include <linux/fs_context.h>

extern struct file_system_type nfs4_fs_type;
COMPAT_FS_CONTEXT_DETECTOR_DECL(nfs4_fs_type);
...
extern int nfs4_proc_setclientid(struct nfs_client *, u32, unsigned short, const struct cred *, 
				 struct pid *pid, struct nfs4_setclientid_res *);
...
extern int nfs4_init_clientid(struct nfs_client *, const struct cred *, struct pid *pid);
extern int nfs41_init_clientid(struct nfs_client *, const struct cred *, struct pid *pid);
...
extern int update_open_stateid(struct nfs4_state *state,
				...
				fmode_t fmode);
extern int nfs4_proc_setlease(struct file *file, FS_SETLEASE_ARG_TYPE arg,
...
#define NFS4_CLIENT_ID_UNIQ_LEN		(72)
