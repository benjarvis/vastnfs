...
#define nfs_ssc_client_tbl \
	nfsbackport_compat_ssc_client_tbl

#define nfs42_ssc_register_ops \
	nfsbackport_compat_nfs42_ssc_register_ops

#define nfs42_ssc_unregister_ops \
	nfsbackport_compat_nfs42_ssc_unregister_ops

#define nfs42_ssc_register \
	nfsbackport_compat_nfs42_ssc_register

#define nfs42_ssc_unregister \
	nfsbackport_compat_nfs42_ssc_unregister

#define nfs_ssc_register \
	nfsbackport_compat_nfs_ssc_register

#define nfs_ssc_unregister \
	nfsbackport_compat_nfs_ssc_unregister
