...
void			rpc_count_iostats_metrics(const struct rpc_task *,
					  struct rpc_iostats *);
void			rpc_clnt_show_stats(struct seq_file *, struct rpc_clnt *, bool);
...
static inline void rpc_clnt_show_stats(struct seq_file *seq, struct rpc_clnt *clnt, bool extra) {}
