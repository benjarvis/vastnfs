#ifndef __COMPAT_FS_CONTEXT_BACKPORT_H__
#define __COMPAT_FS_CONTEXT_BACKPORT_H__
...
#define fs_context_for_submount compat_fs_context_for_submount
#define vfs_get_tree compat_vfs_get_tree
/*
...
#define vfs_get_super compat_vfs_get_super
