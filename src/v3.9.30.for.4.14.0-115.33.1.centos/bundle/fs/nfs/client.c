			   ...
			   struct nfs_subversion *nfs_mod)
{
	...
	struct nfs_client_initdata cl_init = {
		...
		.local_ports_failover = data->local_ports_failover,
		.remote_ports = data->remote_ports,
		.remote_ports_offset = data->nfs_server.remoteports_offset,
		.remote_ports_offset_provided = data->nfs_server.remoteports_offset_provided,
		.no_idle_xprt = data->no_idle_xprt,
	};
	struct nfs_client *clp;
	int error;
